      ...
      <form onSubmit={onSubmitHandler}>
        ...
        <div className="mt-6 flex items-center justify-between gap-4">
          <div className="text-sm w-full flex flex-col">
            ...
            <input type="number" id="min" placeholder="Min" className="py-3 px-2 text-sm mt-2 bg-gray-200 rounded-md focus-visible:outline-gray-500" onChange={handleFormData} />
          </div>
          ...
          <div className="text-sm w-full flex flex-col">
            ...
            <input type="number" placeholder="Max" id="max" className="py-3 px-2 text-sm mt-2 bg-gray-200 rounded-md focus-visible:outline-gray-500" onChange={handleFormData} />
          </div>
        </div>
