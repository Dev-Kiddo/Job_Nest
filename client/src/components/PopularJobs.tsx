import { DatabaseZap, FileUser, LaptopMinimalCheck, LassoSelect, ShieldPlus, TicketCheck, Waypoints, HeartPlus, AudioWaveform, BadgeIndianRupee } from "lucide-react";
...
const populatJobCategories = [
  ...
  { name: "Health&Care", icon: HeartPlus, positionOpen: 99 },
  { name: "Music&audio", icon: AudioWaveform, positionOpen: 121 },
  { name: "Finance", icon: BadgeIndianRupee, positionOpen: 245 },
];
