...
function IconBox({ icon: Icon, count, label, bgColour = "white" }: IconButtonProps) {
  return (
    <div className={`flex-1 ${bgColour} bg-opacity-40 flex items-center justify-between rounded-lg p-4 hover:shadow-md hover:-translate-y-1 transition cursor-pointer group`}>
      <div>
